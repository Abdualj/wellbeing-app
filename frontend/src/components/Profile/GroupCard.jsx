...
const GroupCard = () => {
    ...
    const renderGroupCard = (group) => {
        ...
        return (
            <div 
                key={group.id}
                className="flex items-center gap-3 bg-white rounded-xl p-4 border border-gray-200 hover:border-sage-300 hover:shadow-md transition group"
            >
                <img 
                ...
                <button
                    ...
                    className="relative p-2.5 bg-sage-600 text-white rounded-lg hover:bg-sage-700 transition active:scale-95 flex-shrink-0"
                    title="Open chat"
                >
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                    ...
                    <div className="space-y-3">
                        {createdGroups.map((group) => (
                            <div 
                                key={group.id}
                                className="flex items-center gap-3 bg-white rounded-xl p-4 border border-gray-200 hover:border-amber-400 hover:shadow-md transition"
                            >
                                <img 
                                    src={group.avatar || 'https://via.placeholder.com/48'} 
                                    alt={group.name}
                                ...
                                <button
                                    ...
                                    className="relative p-2.5 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition active:scale-95 flex-shrink-0"
                                    title="Open chat"
                                >
                                    <MessageCircle className="w-4 h-4" />
                ...
                <div className="bg-sage-50 border border-sage-200 rounded-lg p-4">
                    ...
                    <div className="space-y-3">
                        {joinedGroups.map((group) => (
                            <div 
                                key={group.id}
                                className="flex items-center gap-3 bg-white rounded-xl p-4 border border-gray-200 hover:border-sage-400 hover:shadow-md transition"
                            >
                                <img 
                                    src={group.avatar || 'https://via.placeholder.com/48'} 
                                    alt={group.name}
