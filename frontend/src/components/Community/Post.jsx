...
const Post = ({
  ...
  return (
    <div className="px-4 py-2 flex gap-3 border-b border-gray-200 bg-white">
      ...
      <div className="flex-1">
        <div className="flex justify-between items-start">
          <div className="flex flex-wrap items-center gap-1 text-sm">
            ...
            {post.group?.name && (
              <>
                <span className="text-gray-400">·</span>
                <span className="text-gray-400 text-xs">{post.group.name}</span>
              </>
            )}
          </div>
        ...
        {post.content && (
          <p className="text-gray-800 text-sm my-2 leading-relaxed">
            {post.content}
          </p>
        )}
